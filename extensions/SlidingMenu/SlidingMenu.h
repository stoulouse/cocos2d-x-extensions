...
typedef CCMutableArray<CCMenuItemSprite*> CCMenuItemsArray;
...
public:
	...
	virtual bool init();
	virtual void onExit();
	static SlidingMenuGrid* menuWithArray(CCMenuItemsArray* items, int cols, int rows, CCPoint pos , CCPoint pad);
	static SlidingMenuGrid* menuWithArray(CCMenuItemsArray* items, int cols, int rows, CCPoint pos , CCPoint pad, bool vertical);
	bool initWithArray(CCMenuItemsArray* items, int cols, int rows, CCPoint pos , CCPoint pad, bool vertical);
